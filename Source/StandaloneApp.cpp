...
namespace
{
class BrickMawStandaloneApplication final : public juce::JUCEApplication
{
public:
    BrickMawStandaloneApplication()
    {
...
START_JUCE_APPLICATION(BrickMawStandaloneApplication)
